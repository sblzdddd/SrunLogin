...
[Tampermonkey Script (and baka) Ver](https://github.com/sblzdddd/SrunLogin2/blob/main/Tampermonkey/BakaSaveYourMyimaths.user.js), created by [sblzdddd](https://github.com/sblzdddd), referenced respectifully.
